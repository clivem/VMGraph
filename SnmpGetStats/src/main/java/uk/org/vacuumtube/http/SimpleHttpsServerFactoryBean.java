...
public class SimpleHttpsServerFactoryBean implements FactoryBean<HttpsServer>, InitializingBean, DisposableBean {
	...
	/**
	 * @param httpsConfigurator the httpsConfigurator to set
	 */
	...
	public void afterPropertiesSet() throws IOException {
		...
		this.server = HttpsServer.create(address, this.backlog);
	...
	public HttpsServer getObject() {
		return this.server;
	}

	public Class<? extends HttpsServer> getObjectType() {
		return (this.server != null ? this.server.getClass() : HttpsServer.class);
	}
	...
	public void destroy() {
		logger.info("Stopping HttpsServer");
