 ...
 *
 */
public class GetSnmpInterfaceStatisticsJob {

    private static final DateFormat DF_FULL = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss.SSS z");

    private final Logger logger = Logger.getLogger(GetSnmpInterfaceStatisticsJob.class);
	 ...
	 * @param bytes_out_oid
	 */
	public GetSnmpInterfaceStatisticsJob(String address, String bytes_in_oid, String bytes_out_oid, String rrdDbFileName, 
			String archiveInName, String archiveOutName) {
		if (logger.isTraceEnabled()) {
			logger.trace("GetSnmpInterfaceStatisticsJob(address=" + address + ", bytes_in_oid=" + bytes_in_oid + 
	...
	private void openRrdDb() throws IOException {
		if (logger.isTraceEnabled()) {
			logger.trace("GetSnmpInterfaceStatisticsJob.openRrdDb()");
		}
	...
	public void execute() throws IOException {
		if (logger.isTraceEnabled()) {
			logger.trace("GetSnmpInterfaceStatisticsJob.execute(): START");
		}
		...
		if (logger.isTraceEnabled()) {
			logger.trace("GetSnmpInterfaceStatisticsJob.execute(): END");
		}
	}
